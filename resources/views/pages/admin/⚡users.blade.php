    ...
    public function confirmDelete($id)
    {
        try {
            ...
            if ($user->payments()->exists() || $user->pledges()->exists()) {
                ...
                status:"warning",
                title:"Caution",
                message:"User has related payments or pledges. Please remove them first.");
                return;
            }
            ...
            $this->dispatch('toastMagic',status:'error',title:"Error Occured",message:"Unable to delete user.");
        }
    }
...
<div>
    ...
    <x-modal wire:model="showModal">
        <x-card class="relative" title="{{ $isEditMode ? 'Edit User' : 'Create New User' }}">
            <div class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <x-input
                        label="Full Name"
